...
tf::StampedTransform depth_camera_1_tf, depth_camera_2_tf, depth_camera_3_tf;
...
void pointcloud_cb(const sensor_msgs::PointCloud2ConstPtr& pc1, const sensor_msgs::PointCloud2ConstPtr& pc2, const sensor_msgs::PointCloud2ConstPtr& pc3)
{
    ...
    pass.setFilterFieldName ("y");
    pass.setFilterLimitsNegative (false);
    pass.setFilterLimits (-0.945, 0.555);
    pass.filter (*cloudFilteredPtr);
...
int main (int argc, char** argv)
{
    ...
    while(1)
    {
        try
        {
            ...
            listener.lookupTransform("/base_link", "/depth_camera_3_depth_optical_frame", ros::Time(0), depth_camera_3_tf);
            break;
        }
